  ...
  <div class="container">
    <ul class="prop-list">
      <li>
        填充：
        <color-picker
          v-if="polyline.attribute.fill != 'none'"
          v-model:pureColor="polyline.attribute.fill"
          format="rgb"
          shape="square"
          useType="pure"
        />
        <a-select v-model:value="polyline.attribute.fill" style="max-width: 120px">
      ...
      <li>
        笔画颜色：
        <color-picker
          v-model:pureColor="polyline.attribute.stroke"
          format="rgb"
          shape="square"
          useType="pure"
        />
      ...
      <li>
        笔画粗细：
        <a-input-number
          v-model:value="polyline.attribute['stroke-width']"
          :min="0"
        />
      </li>
      <li>
...
const polyline = props.ele;
const strokeDashoffset = ref(
        polyline.attribute["stroke-dasharray"] ? polyline.attribute["stroke-dasharray"] : ""
);
